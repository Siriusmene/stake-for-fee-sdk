...
#[cfg(not(feature = "local"))]
pub const MIN_SECONDS_TO_FULL_UNLOCK: u64 = SECONDS_PER_DAY / 24 * 6; // 6 hours
...
#[cfg(not(feature = "local"))]
pub const MIN_UNSTAKE_LOCK_DURATION: u64 = SECONDS_PER_DAY / 24 * 6; // 6 hours
...
pub const MAX_JOIN_WINDOW_DURATION: u64 = SECONDS_PER_DAY; // 1 days
